...
<body style="margin-left:20px;">
   ...
   <h2>  <span style="color:#86608E;"><center>BATTERY SWAPPING LIST</center>	</span></h2>
       ...
       PreparedStatement pa=con.prepareStatement("SELECT count(*) FROM `evstation`.`recharge` where  status3='B' ");
