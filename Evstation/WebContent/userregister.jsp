...
String path="C:\\Users\\Public\\"+random+".txt";
...
<input type="text" placeholder=" Vehicle Name"  name="id"> <span class="required"> *<!-- </span><input type="button" style="margin-right:-70px;" onclick="location.reload();" value="load"> --> </br>
<input type="text" placeholder=" Vehicle ID"  name="thumb"> <span class="required"> *</span><!--  <input type="button" onclick="location.reload();" style="margin-right:-70px;" value="load"> --></br>

 <input type="text" placeholder="Enter your name" name="name"> <span class="required"> *</span> </br>
<input type="number" placeholder="Enter your Mobile number" name="username"> <span class="required"> *</span> </br>
<input type="email" placeholder="Enter your email" name="email"> <span class="required"> *</span> </br>
<input type="text" placeholder="Enter your Location" name="password1"> <span class="required"> *</span> </br> 
<input type="password" placeholder="Retype your password" name="password2"> <span class="required"> *</span> </br>
<input type="hidden" placeholder="Retype your password" value=<%=path %> name="random"> <span class="required"> 
