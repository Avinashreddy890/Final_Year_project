...
<div class="container">
	<div class="titular">		
		<img src="images/ev charging homepage.jpg" alt="Students gathered around a table, laughing" class="bg"/>
		<!-- <button class="btntop" style="margin-right:240px;"><a href="chiefofficerlogin.jsp">User</a></button>
		<button class="btntop" ><a href="pollingofficerlogin.jsp">Ev Station</a></button> -->
		<p class="tagline">Discover. Connect. Inspire.</p>
		<p class="subtitle">Join us to be a part of a community</p>
		<button class="btn"><a href="pollingofficerlogin.jsp">Get Started</a></button>
	</div>
	<div class="context">
		<br/><br/>
