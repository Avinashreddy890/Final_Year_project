...
<body style="margin-left:20px;">
   ...
   <h2>  <span style="color:#86608E;"><center>RECHARGED LIST</center>	</span></h2>
       ...
       con=dbconn.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `evstation`.`recharge` where status3='D'  ");
       PreparedStatement pa=con.prepareStatement("SELECT count(*) FROM `evstation`.`recharge` where  status3='D' ");
