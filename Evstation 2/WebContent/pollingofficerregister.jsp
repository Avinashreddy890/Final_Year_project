...
<input type="text" placeholder="Ev Station Name"  name="id"> <span class="required"> *<!-- </span><input type="button" style="margin-right:-70px;" onclick="location.reload();" value="load"> --> </br>
<input type="text" placeholder="Create ID"  name="thumb"> <span class="required"> *</span><!--  <input type="button" onclick="location.reload();" style="margin-right:-70px;" value="load"> --></br>
